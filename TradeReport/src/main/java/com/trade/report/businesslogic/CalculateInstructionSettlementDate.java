...
import com.trade.report.businesslogic.workingdays.ArabiaWorkingDays;
import com.trade.report.businesslogic.workingdays.DefaultWorkingDays;
import com.trade.report.model.instruction.Instruction;
import com.trade.report.workingdaysInterface.IWorkingDays;

/**
 * A settlement date calculator
 */
public class CalculateInstructionSettlementDate {
    ...
    public static void calculateSettlementDates(Set<Instruction> instructions) {
        instructions.forEach(CalculateInstructionSettlementDate::calculateSettlementDate);
    }
